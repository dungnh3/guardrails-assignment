...
/*
Package health_api is a reverse proxy.
...
func RegisterHealthCheckServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HealthCheckServiceServer) error {
	...
	mux.Handle("GET", pattern_HealthCheckService_Readiness_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ims.health.service.HealthCheckService/Readiness", runtime.WithHTTPPathPattern("/health/ready"))
		if err != nil {
...
func RegisterHealthCheckServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HealthCheckServiceClient) error {
	...
	mux.Handle("GET", pattern_HealthCheckService_Readiness_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ims.health.service.HealthCheckService/Readiness", runtime.WithHTTPPathPattern("/health/ready"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_HealthCheckService_Readiness_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"health", "ready"}, ""))
)
