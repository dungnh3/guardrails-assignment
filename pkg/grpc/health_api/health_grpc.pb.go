...
func (c *healthCheckServiceClient) Readiness(ctx context.Context, in *ReadinessRequest, opts ...grpc.CallOption) (*ReadinessResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ims.health.service.HealthCheckService/Readiness", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HealthCheckService_Readiness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ims.health.service.HealthCheckService/Readiness",
	}
...
var HealthCheckService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ims.health.service.HealthCheckService",
	...
	Metadata: "pkg/grpc/health_api/health.proto",
}
